    ...
    <PageTransition>
      ...
      <div className="px-6 mb-8">
        <div className="grid grid-cols-2 gap-4">
          ...
          <Link key="feed" to="/community/feed">
          ...
          <Link key="challenges" to="/community/challenges">
            <div className="bg-card rounded-3xl p-6 shadow-card border border-border text-center hover:border-primary transition-smooth">
          ...
          <Link key="groups" to="/community/groups">
            <div className="bg-card rounded-3xl p-6 shadow-card border border-border text-center hover:border-primary transition-smooth">
          ...
          <Link key="friends" to="/community/friends">
            <div className="bg-card rounded-3xl p-6 shadow-card border border-border text-center hover:border-primary transition-smooth">
